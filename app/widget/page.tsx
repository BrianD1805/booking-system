...
export default function WidgetPage() {
  const embedCode = `<iframe src="https://YOUR-BOOKING-DOMAIN.com/book" style="width:100%;min-height:860px;border:0;border-radius:24px;overflow:hidden;" loading="lazy" title="Book an appointment"></iframe>`;

  return (
    <main className="shell">
      <Header area="landing" />
      <section className="card">
        <p className="badge">Website embed route · {APP_VERSION}</p>
